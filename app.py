...
def index ():
    ...
    if request.method =="POST":
        ...
        s1 = "The score of Credit Card upgrade base on Decision Tree model is : " + str(pred1)    
        
        model2 = joblib.load("CCU_RF")
        pred2 = model2.predict([[purchases, suppcard]])
        s2 = "The score of Credit Card upgrade base on Random Forest model is : " + str(pred2)          
        
        model3 = joblib.load("CCU_GB")
        pred3 = model3.predict([[purchases, suppcard]])
        s3 = "The score of Credit Card upgrade base on Gradient Boosting model is : " + str(pred3)  
        
        model4 = joblib.load("CCU_Reg")
        pred4 = model4.predict([[purchases, suppcard]])
        s4 = "The score of Credit Card upgrade base on Linear Regression model is : " + str(pred4)  
        
        model5 = joblib.load("CCU_NN")
        pred5 = model5.predict([[purchases, suppcard]])
        s5 = "The score of Credit Card upgrade base on Neural Network model is : " + str(pred5)  
